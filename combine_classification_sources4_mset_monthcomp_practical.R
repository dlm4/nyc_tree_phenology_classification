...
# Load xgb model
bst_model <- xgb.load("/Volumes/NYC_geo/tree_classification/outputs_practical_v1_monthcomp/practical_v1_monthcomp_xgb_full.model")
...
for (idset in 1:length(step_ranges)){
  ...
  output_name <- paste0("/Volumes/NYC_geo/tree_classification/outputs_practical_v1_monthcomp/predictions/", "practical_xgb_v1_predictions_set", idset, ".csv")
...
setwd("/Volumes/NYC_geo/tree_classification/outputs_practical_v1_monthcomp/predictions")
file_list <- list.files()
...
st_write(out_geodf, "cls_poly_practical_v1_monthcomp.gpkg")

# load confusion matrix
confmat <- readRDS("practical_v1_monthcomp_xgb_full_confmat.rds")

#####
# Merge lidar data into new geopackage with existing classification
setwd("/Volumes/NYC_geo/tree_classification/outputs_practical_v1_monthcomp/")
out_geodf <- st_read("cls_poly_practical_v1_monthcomp.gpkg")
...
setwd("/Volumes/NYC_geo/tree_classification/outputs_practical_v1_monthcomp/")
st_write(out_geodf_2, "cls_poly_practical_v1_monthcomp_w_crown_metrics.gpkg")
