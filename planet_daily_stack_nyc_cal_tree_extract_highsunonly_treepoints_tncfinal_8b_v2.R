...
extractTreesByObjectIDRange <- function(i, sel_tif_images, tree_poly_sf, set_num){
  ...
  extracted_trees2$mean.coastal_blue <- round(extracted_trees2$mean.coastal_blue, digits = 0) # additional bands for 8b version
  extracted_trees2$mean.green_i <- round(extracted_trees2$mean.green_i, digits = 0)
  extracted_trees2$mean.rededge <- round(extracted_trees2$mean.rededge, digits = 0)
  extracted_trees2$mean.yellow <- round(extracted_trees2$mean.yellow, digits = 0)
